...
namespace PersonsInfo {
    public class Person {
        ...
        public string FirstName {
            get => firstName;
            private set {
                if (string.IsNullOrWhiteSpace(value) || value.Length < 3) throw new ArgumentException("First name cannot contain fewer than 3 symbols!");
        ...
        public string LastName {
            get => lastName;
            private set {
                if (string.IsNullOrWhiteSpace(value) || value.Length < 3) throw new ArgumentException("Last name cannot contain fewer than 3 symbols!");
