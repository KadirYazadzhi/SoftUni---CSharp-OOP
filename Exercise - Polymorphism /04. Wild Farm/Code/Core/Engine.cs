...
public class Engine : IEngine {
    ...
    public void Run() {
        ...
        while ((command = this.reader.ReadLine()) != "End"){
            ...
            if (animalType == "Owl") animal = new Owl(inputArguments[1], double.Parse(inputArguments[2]), double.Parse(inputArguments[3]));
            else if (animalType == "Hen") animal = new Hen(inputArguments[1], double.Parse(inputArguments[2]), double.Parse(inputArguments[3]));
            else if (animalType == "Mouse") animal = new Mouse(inputArguments[1], double.Parse(inputArguments[2]), inputArguments[3]);
            else if (animalType == "Cat") animal = new Cat(inputArguments[1], double.Parse(inputArguments[2]), inputArguments[3], inputArguments[4]);
            else if (animalType == "Dog") animal = new Dog(inputArguments[1], double.Parse(inputArguments[2]), inputArguments[3]);
            else if (animalType == "Tiger") animal = new Tiger(inputArguments[1], double.Parse(inputArguments[2]), inputArguments[3], inputArguments[4]);
